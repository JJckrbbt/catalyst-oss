...
import (
	...
	"github.com/jjckrbbt/catalyst/backend/internal/config"
	"github.com/jjckrbbt/catalyst/backend/internal/connections"
	"github.com/jjckrbbt/catalyst/backend/internal/ingestion"
	"github.com/jjckrbbt/catalyst/backend/internal/logger"
...
func main() {
	...
	if cfg.AppEnv == "development" {
		...
		// In staging or production, use the real Auth0 middleware.
		appLogger.Info("Initializing Auth0 middleware for production environment.")
		authMiddleware, err := api.NewAuthMiddleware(cfg.Auth0Domain, cfg.Auth0Audience, platformQuerier, appLogger)
		if err != nil {
